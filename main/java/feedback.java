...
@WebServlet("/feedback-form")
public class feedback extends jakarta.servlet.http.HttpServlet {
	public static  void insert(String email_id,String description,Connection con,HttpServletRequest request,HttpServletResponse resp) throws IOException, ServletException {
		...
		try {
			String sql=String.format("insert into feedback(email_id,description) values('%s','%s')", email_id,description);
